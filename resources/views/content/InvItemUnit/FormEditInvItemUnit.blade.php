...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('inv-item-unit') }}">Daftar Satuan Barang</a></li>
        <li class="breadcrumb-item active" aria-current="page">Edit Satuan Barang</li>
    </ol>
</nav>
            ...
            <div class="row form-group">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control input-bb" type="text" name="item_unit_remark" id="item_unit_remark" value="{{$invitemunit['item_unit_remark']}}"/></textarea>
                    </div>
                </div>
            </div>
        </div>
