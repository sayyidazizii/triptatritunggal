...
@endif
    ...
    <form method="post" action="{{route('process-add-inv-item-unit')}}" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            ...
            <div class="row form-group">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control input-bb" type="text" name="item_unit_remark" id="item_unit_remark" value=""/></textarea>
                    </div>
                </div>
            </div>
        </div>
