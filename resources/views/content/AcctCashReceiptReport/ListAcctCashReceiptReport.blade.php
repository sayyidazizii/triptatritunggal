@inject('AcctCashReceiptReport', 'App\Http\Controllers\AcctCashReceiptReportController')
...
<h3 class="page-title">
    <b>Laporan Penerimaan Kas</b> <small>Daftar Penerimaan Kas </small>
</h3>
<br/>
<div id="accordion">
    <form  method="post" action="{{route('report-filter-cash-receipt')}}" enctype="multipart/form-data">
    @csrf
            ...
            <table id="example" style="width:100%" class="table table-striped table-bordered table-hover table-full-width">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$receipt['cash_receipt_date']}}</td>
                        <td>{{$receipt['cash_receipt_no']}}</td>
                        <td>{{$receipt['cash_receipt_title']}}</td>
                        <td style='text-align:right'>{{number_format($receipt['cash_receipt_amount_total'], 0, '', '.')}}</td>
                    </tr>
                    <?php $no++?>
                    @endforeach
                </tbody>
