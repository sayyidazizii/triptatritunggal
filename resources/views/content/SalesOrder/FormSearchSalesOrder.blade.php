@inject('SalesOrderApproval', 'App\Http\Controllers\SalesOrderController')
            ...
            <table id="example" style="width:100%" class="table table-striped table-bordered table-hover table-full-width">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php
                        if($item['sales_quotation_status']==0){
                            ?>
                            <td>Dalam Proses</td>
                        <?php
                        }else if($item['sales_quotation_status']==1) {
                            ?>
                            <td>Sebagian diterima</td>
                            <?php
                        }else if($item['sales_quotation_status']==2) {
                            ?>
                        ...
                        <td style='text-align:center'>
                            <a type="button" class="btn btn-outline-primary btn-sm" href="{{ url('/sales-order/add/'.$item['sales_quotation_id']) }}">Tambah Sales Order</a>
                        </td>
                    </tr>
                    <?php $no++; ?>
                    @endforeach
