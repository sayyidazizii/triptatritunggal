...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('preference-company') }}">Daftar PPN Default</a></li>
        <li class="breadcrumb-item active" aria-current="page">Edit PPN Default</li>
    </ol>
</nav>
    ...
    <form method="post" action="{{route('process-edit-ppn-preference-company')}}" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class="row form-group">
                <div class="col-md-6">
                    <div class="form-group">
                        <a class="text-dark">PPN IN Default<a class='red'> *</a></a>
                        <input class="form-control input-bb" type="text" name="ppn_amount_in" id="ppn_amount_in" value="{{$preferencecompany['ppn_amount_in']}}"/>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <a class="text-dark">PPN Out Default<a class='red'></a></a>
                        <input class="form-control input-bb" type="text" name="ppn_amount_out" id="ppn_amount_out" value="{{$preferencecompany['ppn_amount_out']}}"/>
                    </div>
                </div>
            </div>
