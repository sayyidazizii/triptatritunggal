...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Hapus Permintaan Pengeluaran Gudang</li>
    </ol>
</nav>
...
<h3 class="page-title">
    <b>Form Hapus Permintaan Pengeluaran Gudang</b>
</h3>
<br/>
@if(session('msg'))
    ...
    <div class="card border border-dark">
        ...
        <div class="card-footer text-muted">
            <div class="form-actions float-right">
                <button type="submit" name="Save" class="btn btn-danger btn-sm" title="Save">Hapus</button>
            </div>
        </div>
    </div>
    </form>
