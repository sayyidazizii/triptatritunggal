...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('sales-delivery-order/edit/'.$sales_delivery_order_id) }}">Edit Sales Delivery Order</a></li>
        <li class="breadcrumb-item active" aria-current="page">Edit Detail Item Stock Sales Delivery Order</li>
    </ol>
</nav>
...
<h3 class="page-title">
    <b>Form Edit Detail Item Stock Sales Delivery Order</b>
</h3>
<br/>
@if(session('msg'))
    ...
    <div class="card border border-dark">
        <div class="card-header border-dark bg-dark">
            ...
            <div class="float-right">
                ...
                <button onclick="location.href='{{ url('sales-delivery-order/edit/'.$sales_delivery_order_id) }}'" name="Find" class="btn btn-sm btn-info" title="Back"><i class="fa fa-angle-left"></i>  Kembali</button>
            </div>
        </div>
