...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Detail Sales Delivery Order</li>
    </ol>
</nav>
...
<h3 class="page-title">
    <b>Form Detail Sales Delivery Order</b>
</h3>
<br/>
@if(session('msg'))
                                    ...
                                    @endphp
                                            <tr>
                                                ...
                                                <td style='text-align:center;'>
                                                    <a href='{{url('sales-delivery-order/detail/detail-item-stock/'.$val['sales_delivery_order_id'].'/'.$val['sales_delivery_order_item_id'])}}' class="btn btn-outline-info btn-sm" title="Detail Stock">Detail Stock</a>
                                                </td>
                                            </tr>
                                        @php
                                            $no++;
