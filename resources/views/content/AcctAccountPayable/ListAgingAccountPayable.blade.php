@inject('AcctAgingApReportController', 'App\Http\Controllers\AcctAgingApReportController')
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Daftar Aging Hutang Supplier</li>
    </ol>
</nav>
...
<h3 class="page-title">
    <b>Daftar Aging Hutang Supplier</b> <small>Mengelola Aging Hutang Supplier</small>
</h3>
<br/>
<div id="accordion">
        ...
        <div class="table-responsive">
            <table id="example" style="width:100%" class="table table-striped table-bordered table-hover table-full-width">
                ...
                <tbody>
                    ...
                    <?php
                     $aging = $AcctAgingApReportController->calculateDateDifference($item['purchase_invoice_date'],date('d-m-Y'))
                     ?>
                    <tr>
                        <td style='text-align:center'>{{$no}}.</td>
                        <td>{{$AcctAgingApReportController->getSupplierName($item['supplier_id'])}}</td>
