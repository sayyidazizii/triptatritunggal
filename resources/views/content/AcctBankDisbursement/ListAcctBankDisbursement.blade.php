...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Daftar Pengeluaran Bank</li>
    </ol>
  </nav>
...
<h3 class="page-title">
    <b>Daftar Pengeluaran Bank</b> <small>Mengelola Pengeluaran Bank </small>
</h3>
<br/>
<div id="accordion">
    <form  method="post" action="/bank-disbursement/filter" enctype="multipart/form-data">
    @csrf
...
<div class="card border border-dark">
  <div class="card-header bg-dark clearfix">
    ...
    <div class="form-actions float-right">
        <a  href="{{route('add-bank-disbursement')}}" name="Find" class="btn btn-sm btn-info" title="Add Data"><i class="fa fa-plus"></i> Tambah Pengeluaran Bank Baru</a>
    </div>
  </div>
            ...
            <table id="example" style="width:100%" class="table table-striped table-bordered table-hover table-full-width">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$AcctBankDisbursement->getCustomerName($disbursement['customer_id'])}}</td>
                        <td>{{date('d/m/Y', strtotime($disbursement['bank_disbursement_date']))}}</td>
                        ...
                        <td class="" style='text-align:center'>
                            <a type="button" class="btn btn-outline-warning btn-sm" href="{{route('detail-bank-disbursement', ['bank_disbursement_id' => $disbursement['bank_disbursement_id']])}}" >Detail</a>
                            <a type="button" class="btn btn-outline-danger btn-sm" href="{{route('void-bank-disbursement', ['bank_disbursement_id' => $disbursement['bank_disbursement_id']])}}">Batal</a>
                        </td>
                    </tr>
                    <?php $no++?>
                    @endforeach
