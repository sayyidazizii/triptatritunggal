            ...
            <div class="row form-group">
                <div class="col-md-4">
                    <div class="form-group form-md-line-input">
                        ...
                        <input class="form-control input-bb" type="text" name="customer_id" id="customer_id" value="{{$AcctBankDisbursement->getCustomerName($acctdisbursementdetail['customer_id'])}}" readonly/>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group form-md-line-input">
                        ...
                        <input class="form-control input-bb" type="text" name="bank_disbursement_date" id="bank_disbursement_date" value="{{date('d/m/Y', strtotime($acctdisbursementdetail['bank_disbursement_date']))}}" readonly/>
                    </div>
                </div>
                <div class="col-md-4">
