...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Edit Invoice Pembelian</li>
    </ol>
</nav>
...
<h3 class="page-title">
    <b>Form Edit Invoice Pembelian</b>
</h3>
<br/>
@if(session('msg'))
        ...
        <div class="card-body">
            <div class="row form-group">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control input-bb" type="text" name="purchase_invoice_no" id="purchase_invoice_no" value="{{$purchaseinvoice['purchase_invoice_no']}}"/>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
            ...
            <div class="row form-group">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type ="date" class="form-control form-control-inline input-medium date-picker input-date" data-date-format="dd-mm-yyyy" type="text" name="purchase_invoice_date" id="purchase_invoice_date" onChange="function_elements_add(this.name, this.value);" value="{{$purchaseinvoice['purchase_invoice_date']}}"/>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <a class="text-dark">Tanggal Jatuh Tempo<a class='red'> *</a></a>
                        <input type ="date" class="form-control form-control-inline input-medium date-picker input-date" data-date-format="dd-mm-yyyy" type="text" name="purchase_invoice_due_date" id="purchase_invoice_due_date" onChange="function_elements_add(this.name, this.value);" value="{{$purchaseinvoice['purchase_invoice_due_date']}}"/>
                    </div>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="row form-group">
                <div class="col-md-12">
                    ...
                    <div class="">
                        <textarea rows="3" type="text" class="form-control input-bb" name="purchase_invoice_remark" onChange="elements_add(this.name, this.value);" id="purchase_invoice_remark" >{{$purchaseinvoice['purchase_invoice_remark']}}</textarea>
                    </div>
                </div>
            </div>
        </div>
