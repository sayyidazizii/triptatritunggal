...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Void Invoice Pembelian</li>
    </ol>
  </nav>
...
@endif
    ...
    <form method="post" action="{{route('process-void-purchase-invoice')}}" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            ...
            <div class="row form-group">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control input-bb" type="text" name="purchase_invoice_date" id="purchase_invoice_date" onChange="function_elements_add(this.name, this.value);" value="{{$purchaseinvoice['purchase_invoice_date']}}" readonly/>
                    </div>
                </div>
            </div>
            <div class="row form-group">
    ...
    <div class="card border border-dark">
        ...
        <div class="card-footer text-muted">
            <div class="form-actions float-right">
                <button type="submit" name="Save" class="btn btn-danger" title="Save">Void</button>
            </div>
        </div>
    </div>
</form>
