@inject('PurchaseInvoiceReport', 'App\Http\Controllers\PurchaseInvoiceReportController')
            ...
            <table id="example" style="width:100%" class="table table-striped table-bordered table-hover table-full-width">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->purchaseInvoice->purchase_invoice_no }}</td>
                        <td>{{ $item->purchaseInvoice->CoreSupplier->supplier_name }}</td>
                        <td>{{ $item->purchaseInvoice->formatted_date  }}</td>
                        <td>{{ $item->InvItemType->item_type_name }}</td>
                        <td>{{ number_format($item->quantity) }}</td>
                        <td>{{ number_format($item->item_unit_cost * $item->quantity) }}</td>
                    ...
                    <tr class="text-bold">
                        ...
                        <td colspan="2" style='text-align:center'>
                            ...
                            <a href="{{ url('purchase-invoice-report/export') }}" name="Find" class="btn btn-sm btn-info" title="Export Excel"><i class="fa fa-print"></i>Export</a>
                            @endif
                        </td>
                    </tr>
            </table>
