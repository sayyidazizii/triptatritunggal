...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Tambah Package</li>
    </ol>
  </nav>
...
@endif
    ...
    <form method="post" action="{{route('process-add-core-package')}}" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            <div class="row form-group">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input class="form-control input-bb" type="text" name="package_name" id="package_name" value=""/>
                    </div>
                </div>
            </div>
        </div>
