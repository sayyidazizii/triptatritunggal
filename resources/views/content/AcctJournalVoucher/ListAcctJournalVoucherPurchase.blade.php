...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Daftar Jurnal Pembelian</li>
    </ol>
</nav>
...
<form  method="post" action="{{route('filter-journal-purchase')}}" enctype="multipart/form-data">
@csrf
    <div class="card-body">
        <div class='row'>
            <div class = "col-md-4">
    ...
    <div class="card-footer text-muted">
        <div class="form-actions float-right">
            <a type="reset" name="Reset" class="btn btn-sm btn-info" target="_blank" href="{{route('printing-journal-purchase')}}"><i class="fa fa-eye"></i> Preview</a>
            <a type="submit" name="Find" class="btn btn-sm btn-primary" href="{{route('export-journal-purchase')}}"><i class="fa fa-download"></i> Export Data</a>
        </div>
    </div>
  </div>
</div>
