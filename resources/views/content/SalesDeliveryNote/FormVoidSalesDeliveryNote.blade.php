...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Void Sales Delivery Note</li>
    </ol>
</nav>
...
@endif
    ...
    <form method="post" action="{{route('process-void-sales-delivery-note')}}" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            <div class="row">
                <h5 class="form-section"><b>Void Sales Delivery Order</b></h5>
            </div>
            <hr style="margin:0;">
            <br/>
            ...
            <div class="row">
                <h5 class="form-section"><b>Form Void</b></h5>
            </div>
            <hr style="margin:0;">
            <br/>
            <div class="row form-group">
    ...
    <div class="card border border-dark">
        ...
        <div class="card-footer text-muted">
            <div class="form-actions float-right">
                <button type="submit" name="Save" class="btn btn-danger btn-sm" title="Save"><i class="fa fa-times"></i> Hapus</button>
            </div>
        </div>
    </div>
    </form>
