            ...
            <table id="example" style="width:100%" class="table table-striped table-bordered table-hover table-full-width">
                <thead>
                    <tr>
                        ...
                        <th width="13%" style='text-align:center'>Tanggal Quotation</th>
                        <th width="15%" style='text-align:center'>No. Quotation</th>
...
{{--                        <td>{{$SalesDeliveryNote->getInvWarehouseName($item['warehouse_id'])}}</td>--}}
                        <td style='text-align:center'>
                            <a type="button" class="btn btn-outline-primary btn-sm" href="{{ url('/sales-delivery-note/add/'.$item['sales_quotation_id']) }}"><i class="fa fa-plus"></i></a>
                        </td>
                    </tr>
                    <?php $no++; ?>
                    @endforeach
