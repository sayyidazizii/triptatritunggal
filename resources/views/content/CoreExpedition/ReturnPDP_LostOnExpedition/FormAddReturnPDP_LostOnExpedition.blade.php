...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('return-pdp-lost-on-expedition') }}">Daftar PDP Hilang Di Expedisi</a></li>
        <li class="breadcrumb-item"><a href="{{ url('return-pdp-lost-on-expedition/search-sales-delivery-note') }}">Daftar Sales Delivery Note</a></li>
        <li class="breadcrumb-item active" aria-current="page">Tambah PDP Hilang Di Expedisi</li>
    </ol>
</nav>
...
<h3 class="page-title">
    Form Tambah PDP Hilang Di Expedisi
</h3>
<br/>
@if(session('msg'))
...
@endif
    ...
    <div class="card-header border-dark bg-dark">
        ...
        <div class="float-right">
            <button onclick="location.href='{{ url('return-pdp-lost-on-expedition/search-sales-delivery-note') }}'" name="Find" class="btn btn-sm btn-info" title="Back"><i class="fa fa-angle-left"></i>  Kembali</button>
        </div>
    </div>

    <form method="post" action="{{route('process-add-return-pdp-lost-on-expedition')}}" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            <div class="row form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type ="date" class="form-control form-control-inline input-medium date-picker input-date" data-date-format="dd-mm-yyyy" type="text" name="return_pdp_lost_on_expedition_date" id="return_pdp_lost_on_expedition_date" onChange="function_elements_add(this.name, this.value);" value=""/>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <a class="text-dark">Alasan<a class='red'> *</a></a>
                        <div class="">
                            <textarea rows="3" type="text" class="form-control input-bb" name="return_pdp_lost_on_expedition_remark" id="return_pdp_lost_on_expedition_remark" onChange="function_elements_add(this.name, this.value);" ></textarea>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card border border-dark">
        ...
        <div class="card-footer text-muted">
            <div class="form-actions float-right">
                <a name='Reset'  class='btn btn-danger btn-sm' onClick='javascript:confirm(\"apakah yakin ingin dihapus ?\")'><i class="fa fa-times"></i> Reset</a>
