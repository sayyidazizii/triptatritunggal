@inject('AcctDebtCard', 'App\Http\Controllers\AcctDebtCardController')
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Daftar Kartu Hutang</li>
    </ol>
</nav>
...
<h3 class="page-title">
    <b>Daftar Kartu Hutang</b> <small>Mengelola Kartu Hutang</small>
</h3>
<br/>
<div id="accordion">
    <form  method="post" action="{{route('filter-debt-card')}}" enctype="multipart/form-data">
    @csrf
            ...
            <table id="example" style="width:100%" class="table table-striped table-bordered table-hover table-full-width">
                <thead>
                    <tr>
                        ...
                        <th width="10%" style='text-align:center'>Hutang Baru</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style='text-align:center'>
                            <a type="button" class="btn btn-outline-primary btn-sm" href="{{ url('/debt-card/print/'.$item['supplier_id']) }}">Print</a>
                        </td>
                    </tr>
                    <?php $no++; ?>
                    @endforeach
