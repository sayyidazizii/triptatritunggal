@inject('AcctCashDisbursementReport', 'App\Http\Controllers\AcctCashDisbursementReportController')
...
<h3 class="page-title">
    <b>Laporan Pengeluaran Kas</b> <small>Daftar Pengeluaran Kas </small>
</h3>
<br/>
<div id="accordion">
    <form  method="post" action="{{route('report-filter-cash-disbursement')}}" enctype="multipart/form-data">
    @csrf
            ...
            <table id="example" style="width:100%" class="table table-striped table-bordered table-hover table-full-width">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$disbursement['cash_disbursement_date']}}</td>
