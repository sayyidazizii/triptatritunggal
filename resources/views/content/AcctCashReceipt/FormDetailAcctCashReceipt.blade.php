...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('receipt') }}">Daftar Penerimaan Kas</a></li>
            ...
            <div class="row form-group">
                <div class="col-md-4">
                    <div class="form-group form-md-line-input">
                        ...
                        <input class="form-control input-bb" type="text" name="check_receipt_date" id="check_receipt_date" value="{{$AcctCashReceipt->getCustomerName($acctreceiptdetail['customer_id'])}}" readonly/>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group form-md-line-input">
                        ...
                        <input class="form-control input-bb" type="text" name="cash_receipt_date" id="cash_receipt_date" value="{{$acctreceiptdetail['cash_receipt_date']}}" readonly/>
                    </div>
                </div>
                <div class="col-md-4">
                    <a class="text-dark">No Penerimaan</a>
                    <input class="form-control input-bb" type="text" name="cash_receipt_no" id="cash_receipt_no" value="{{$acctreceiptdetail['cash_receipt_no']}}" readonly/>
                </div>
            </div>
            <div class="row form-group">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control input-bb" type="text" name="cash_receipt_title" id="cash_receipt_title" value="{{$acctreceiptdetail['cash_receipt_title']}}" readonly/>
                    </div>
                </div>
            </div>	
            <div class = "row form-group">
                <div class="col-md-12 ">
                    ...
                    <div class="">
                        <textarea rows="3" type="text" class="form-control input-bb" name="cash_receipt_description" onChange="function_elements_add(this.name, this.value);" id="cash_receipt_description"  readonly>{{$acctreceiptdetail['cash_receipt_description']}}</textarea>
                    </div>
                </div>
            </div>
            <br/>
