...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Close Invoice Penjualan</li>
    </ol>
</nav>
...
@endif
    ...
    <form method="post" action="{{route('process-closed-sales-invoice')}}" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
    ...
    <div class="card border border-dark">
        ...
        <div class="card-footer text-muted">
            <div class="form-actions float-right">
                <button type="submit" name="Save" class="btn btn-success" title="Save">Close</button>
            </div>
        </div>
    </div>
</form>
