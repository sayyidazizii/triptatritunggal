...
@endif
    ...
    <form method="post" action="{{route('process-add-inv-item')}}" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            ...
            <div class="row form-group">
                <div class="col-md-6">
                    ...
                    {!! Form::select('inv_account_id',  $acctaccountcode, 0, ['class' => 'selection-search-clear select-form', 'id' => 'inv_account_id']) !!}
                </div>
                <div class="col-md-6">
                    <a class="text-dark">COA Retur Persediaan</a>
                    {!! Form::select('inv_return_account_id',  $acctaccountcode, 0, ['class' => 'selection-search-clear select-form', 'id' => 'inv_return_account_id']) !!}
                </div>
            </div>
            <div class="row form-group">
                <div class="col-md-6">
                    <a class="text-dark">COA Diskon Persediaan</a>
                    {!! Form::select('inv_discount_account_id',  $acctaccountcode, 0, ['class' => 'selection-search-clear select-form', 'id' => 'inv_discount_account_id']) !!}
                </div>
            </div>
            <div class="row form-group">
                <div class="col-md-6">
                    <a class="text-dark">COA HPP</a>
                    {!! Form::select('hpp_account_id',  $acctaccountcode, 0, ['class' => 'selection-search-clear select-form', 'id' => 'hpp_account_id']) !!}
                </div>
            </div>
