...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('grading/search-item-stock') }}">Daftar Barang No Grade</a></li>
...
@endif
    ...
    <form method="post" action="{{route('process-add-grading')}}" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            <div class="row">
