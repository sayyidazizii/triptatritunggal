    ...
    <div class="card border border-dark">
        <div class="card-header border-dark bg-dark">
            ...
            <div class="float-right">
                <button onclick="location.href='{{ url('/sales-collection-piece') }}'" name="Find"
    ...
    <div class="card border border-dark">
        ...
        <div class="card-footer text-muted">
            <div class="form-actions float-right">
                <a id="add-piece-button"  type="button" onclick="datapiece_add({{ $item['sales_invoice_id'] }});" class="btn btn-primary btn-sm" ><i class="fa fa-check"></i>Batal</a>
            </div>
        </div>
    </div>
    @php
