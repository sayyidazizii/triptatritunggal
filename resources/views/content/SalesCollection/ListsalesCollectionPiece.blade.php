...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Daftar Claim Potongan</li>
    </ol>
</nav>
...
<h3 class="page-title">
    <b>Daftar Claim Potongan</b> <small>Mengelola Potongan Invoice Penjualan</small>
</h3>
<br/>
<div id="accordion">
    <form  method="post" action="{{route('filter-sales-collection-piece')}}" enctype="multipart/form-data">
    @csrf
...
<div class="card border border-dark">
    <div class="card-header bg-dark clearfix">
        ...
        <div class="form-actions float-right">
            <button onclick="location.href='{{ url('sales-collection-piece/search-sales-collection-piece') }}'" name="Find" class="btn btn-sm btn-info" title="Add Data"><i class="fa fa-plus"></i> Tambah Claim Potongan Invoice Baru</button>
        </div>
    </div>
            ...
            <table id="example" style="width:100%" class="table table-striped table-bordered table-hover table-full-width">
                <thead>
                    <tr>
                        ...
                        <th width="20%" style='text-align:center'>Jumlah Setelah Potongan</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="">
                            <a type="button" class="btn btn-outline-primary btn-sm" href="{{ url('/sales-collection-piece/detail-claim-sales-collection-piece/'.$item['sales_invoice_id']) }}">Detail</a>
                            <a type="button" class="btn btn-outline-danger btn-sm" href="{{ url('/sales-collection-piece/cancel-claim-sales-collection-piece/'.$item['sales_invoice_id']) }}">Batal</a>
                        </td>
                    </tr>
                    <?php $no++; ?>
                    @endforeach
