...
CREATE TABLE `acct_account` (
  ...
  `account_code` varchar(225) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `account_name` varchar(225) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `account_group` varchar(225) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `account_suspended` int DEFAULT '0',
  `account_default_status` int DEFAULT '0',
  `account_remark` varchar(225) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `account_status` int DEFAULT '0',
  `account_token` varchar(225) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `acct_profit_loss_report` (
  ...
  `account_type_id` int DEFAULT NULL,
  `account_id` int DEFAULT NULL,
  `account_code` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `account_name` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `report_formula` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `report_operator` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=4766 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=66 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=COMPACT;
