...
class AcctAgingArReportController extends Controller
{
    //
    public function index()
    {
        ...
        return view('content/AcctAccountReceivable/ListAccountReceivable', compact('salesinvoice', 'start_date', 'end_date', 'customer_id', 'customer'));
    }

    public function filterAcctAgingAr(Request $request){
        ...
        return redirect('/aging-account-receivable');
    }

    public function resetFilterAcctAgingAr(){
    ...
    public function getCustomerName($customer_id){
        $supplier = CoreCustomer::select('customer_name')
        ->where('data_state', 0)
        ->where('customer_id', $customer_id)
        ->first();

        return $supplier['customer_name'];
    }
