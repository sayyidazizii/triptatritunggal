...
class AcctJournalVoucherController extends Controller
{
    /**
    ...
    public function index()
    {
       ...
       // dd($acctjournalvoucher);
        return view('content/AcctJournalVoucher/ListAcctJournalVoucher', compact('acctjournalvoucher','start_date','end_date','corebranch','branch_id'));
    }
